    ...
    <PolicyLayout title="Cookie Policy" lastUpdated="January 1, 2024">
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2 text-muted-foreground list-disc pl-6">
          <li>
            <strong>Session Cookies:</strong> These are temporary cookies that exist only while your
            browser is open. They are deleted when you close your browser.
          </li>
          <li>
            <strong>Persistent Cookies:</strong> These remain until you delete them or they expire,
            helping us recognize your browser on return visits.
          </li>
          <li>
            <strong>First-party Cookies:</strong> Set by {company.name} directly for optimal site
            functionality.
          </li>
          <li>
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          reporting information anonymously. They help us improve website performance and user
          experience.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          of these cookies as the website cannot function properly without them.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          ...
          not directly store personal information but uniquely identify your browser and device.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2 text-muted-foreground list-disc pl-6">
          <li>
            Browser Settings: Most browsers allow you to refuse or accept cookies, delete existing
            cookies, and set preferences for certain websites.
          </li>
          <li>
            Opt-out Links: For third-party cookies, you can often opt out through the respective
            service provider&apos;s website.
          </li>
          <li>
            Mobile Device Settings: Some mobile devices allow you to control tracking through their
            settings.
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2 text-muted-foreground list-disc pl-6">
          <li>
            Google Analytics: One of the most widespread and trusted analytics solutions. Helps us
            understand how you use the site and ways to improve your experience.
          </li>
          <li>
            Social Media Cookies: Allow you to share content directly on social media platforms.
          </li>
        </ul>
      </section>
