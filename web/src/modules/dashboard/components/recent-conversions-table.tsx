...
export function RecentConversionsTable({
  themeMode = "dark",
  contacts = [],
  ...
  return (
    <section
      className={`p-6 rounded-none space-y-4 font-sans border ${
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <span className={`text-xs ${isDark ? "text-[#a1a1a1]" : "text-slate-500"}`}>
          Live database inquiries
        </span>
      </div>
          ...
          >
            {rows.length === 0 ? (
              ...
              rows.map((cnv) => (
                ...
                >
                  <td className={`p-3 font-mono ${isDark ? "text-[#a1a1a1]" : "text-slate-500"}`}>
                    {cnv.time}
                  </td>
                  <td className={`p-3 font-bold ${isDark ? "text-[#ededed]" : "text-slate-900"}`}>
                    {cnv.leadName}
                  </td>
                  <td className={`p-3 ${isDark ? "text-[#ededed]" : "text-slate-700"}`}>
                    {cnv.email}
                  </td>
                  <td className={`p-3 font-medium ${isDark ? "text-[#ededed]" : "text-slate-900"}`}>
                    {cnv.service}
                  </td>
