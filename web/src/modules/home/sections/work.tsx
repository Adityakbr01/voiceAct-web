      ...
      <div className="mt-16 flex flex-col gap-4">
        {work.map((w, i) => (
          <motion.a
            ...
            className="group relative overflow-hidden rounded-2xl border border-border/60 bg-[var(--gradient-card)] shadow-[var(--shadow-card)] p-4 transition-all duration-500 hover:border-primary/40 sm:rounded-3xl sm:p-6 md:p-10"
          >
