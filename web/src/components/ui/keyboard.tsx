...
const SOUND_DEFINES_UP: Record<string, [number, number]> = Object.fromEntries(
  Object.entries(SOUND_DEFINES_DOWN).map(([k, [s, d]]) => [k, [s + Math.floor(d * 0.9), Math.max(70, Math.floor(d * 0.85))]]),
);
...
const Key = ({
  ...
  return (
    ...
    >
      <div className={cn("flex h-full w-full flex-col items-center justify-center", childrenClassName)}>
        {children}
      </div>
    </div>
  );
...
export const Keypad = () => {
  return (
    <div className="h-full w-fit rounded-xl bg-muted p-1 shadow-sm ring-1 shadow-black/5 ring-border">
      ...
      {/* Bottom Row */}
      <Row>
        <Key keyCode="Fn" containerClassName="rounded-bl-xl" className="rounded-bl-lg" childrenClassName="items-start justify-end pb-[2px] pl-[4px]">
          <div className="flex w-full justify-between"><span>fn</span></div>
          <div className="flex w-full justify-between"><IconWorld className="h-[6px] w-[6px]" /></div>
        </Key>
        <Key keyCode="ControlLeft" childrenClassName="items-start justify-end pb-[2px] pl-[4px]">
          <div className="flex w-full justify-end"><IconChevronUp className="h-[6px] w-[6px]" /></div>
        ...
        <Key keyCode="AltLeft" childrenClassName="items-start justify-end pb-[2px] pl-[4px]">
          <div className="flex w-full justify-end pr-1"><IconCaretUpFilled className="h-[4px] w-[4px]" /></div>
          <div className="flex w-full justify-start">option</div>
        </Key>
        <Key keyCode="MetaLeft" className="w-8" childrenClassName="items-start justify-end pb-[2px] pl-[4px]">
        ...
        <Key keyCode="MetaRight" className="w-8" childrenClassName="items-start justify-start pb-[2px] pl-[4px]">
        ...
        <Key keyCode="AltRight" childrenClassName="items-start justify-start pb-[2px] pl-[4px]">
          <div className="flex w-full justify-start pl-1"><IconCaretUpFilled className="h-[4px] w-[4px]" /></div>
          <div className="flex w-full justify-start">option</div>
        </Key>
        <div className="flex flex-col gap-[2px]">
          <div className="flex gap-[2px]">
            <Key className="h-[11px]" />
            <Key keyCode="ArrowUp" className="h-[11px]"><IconCaretUpFilled className="h-[4px] w-[4px]" /></Key>
            <Key className="h-[11px]" containerClassName="rounded-br-xl" />
          </div>
          <div className="flex gap-[2px]">
            <Key keyCode="ArrowLeft" className="h-[11px]"><IconCaretLeftFilled className="h-[4px] w-[4px]" /></Key>
            <Key keyCode="ArrowDown" className="h-[11px]"><IconCaretDownFilled className="h-[4px] w-[4px]" /></Key>
            <Key keyCode="ArrowRight" className="h-[11px]" containerClassName="rounded-br-xl"><IconCaretRightFilled className="h-[4px] w-[4px]" /></Key>
          </div>
        </div>
      </Row>
    </div>
