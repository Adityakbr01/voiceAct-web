...
3. **Reciprocity — give value before asking.** Deliver a useful result (score, preview, partial report, generated artifact) *before* the signup wall. Gate the *export/save*, not the *insight*.
4. **IKEA / Endowment Effect — ownership creates commitment.** Let users pick a theme, name their workspace, customize, or complete a first task *before* the signup form. Abandoning must feel like losing something they built.
...
3. Find the signup/payment wall. Move at least one useful output *above* it.
