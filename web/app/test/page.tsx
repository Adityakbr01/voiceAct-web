    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#09090b] px-6 py-12">
      ...
      <div className="sm:px-6 md:px-10 relative max-w-7xl mx-auto w-full pt-16 pr-4 pb-16 pl-4">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-0 bottom-0 h-[80%] w-[60%] rounded-[40%] bg-gradient-to-tr from-white/5 to-transparent blur-3xl" />
        </div>
        ...
        {/* Heading */}
        <h2 className="mt-4 text-center font-sans text-4xl font-light tracking-tighter text-white sm:text-6xl">
          Let&apos;s Stay{" "}
          <span className="font-sans text-white/90 font-light tracking-tighter">
            Connected
          </span>
        </h2>

        {/* Copy */}
        <p className="mx-auto mt-4 max-w-xl text-center font-sans text-sm text-neutral-400 sm:text-base">
        ...
        <div className="mt-6 flex justify-center">
          <a
            href="#contact"
            className="group relative inline-flex h-12 items-center gap-2 overflow-hidden rounded-full bg-white/5 px-6 font-sans text-sm font-medium tracking-tight text-white ring-1 ring-white/10 shadow-[inset_0_-2px_0_rgba(255,255,255,0.15)] transition-all duration-200 hover:bg-white/10 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
          >
            <span
              aria-hidden
        ...
        <div className="mt-8 flex items-center justify-center gap-6 text-neutral-400">
          ...
          <a
            ...
            className="rounded p-2 transition hover:bg-white/5 hover:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
        ...
        <p className="mt-6 text-center">
          <a
            ...
            className="font-sans text-sm text-neutral-300 underline underline-offset-4 hover:text-white"
          >
            hello@voiceact.in
          </a>
        </p>
